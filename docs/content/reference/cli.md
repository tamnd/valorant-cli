...
```
valorant <command> [arguments] [flags]
```

Run `valorant <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `valorant/domain.go`.
