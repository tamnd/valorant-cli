...
Most of these come down to network reality or how valorant serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

valorant rate-limits like any public site. valorant already paces
...
Where a surface is gated, valorant reads a cookie or token you supply
...
`valorant`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what valorant actually did
